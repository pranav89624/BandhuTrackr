...
const FakeDemo: React.FC = React.memo(() => {
  ...
  return (
    <section className="py-20" aria-labelledby="demo-heading" role="region">
      <div className="container mx-auto px-6">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 id="demo-heading" className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
            {demo.heading}
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-4">{demo.subheading}</p>
        </motion.div>
        ...
        >
          ...
          <div className="overflow-x-auto" role="region" aria-label={demo.ariaLabels?.table}>
            <table className="w-full" role="table" aria-label={demo.ariaLabels?.tableDescription}>
        ...
        <div className="flex justify-center mt-8">
          <p className="text-sm text-gray-500 mt-6 italic">
            *Disclaimer: This is just a mock-up. Actual results may be more heartbreaking.
          </p>
        </div>
      </div>
    </section>
