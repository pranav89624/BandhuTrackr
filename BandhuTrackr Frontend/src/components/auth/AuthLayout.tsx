          ...
          <AnimatePresence mode="wait">
            {mode === 'login' ? (
              ...
              >
                ...
                <div className="w-1/2 bg-gradient-to-bl from-orange-400 to-red-500" role="complementary">
                  <DecorationPanel 
                    mode="login" 
              ...
              >
                ...
                <div className="w-1/2 bg-gradient-to-bl from-green-400 to-teal-500" role="complementary">
                  <DecorationPanel 
                    mode="signup" 
                    headline={currentContent.decoration.headline}
                    subtitle={currentContent.decoration.subtitle}
